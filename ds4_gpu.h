...
int ds4_gpu_matmul_q6_k_q8_k_tensor(
        ds4_gpu_tensor       *out,
        const void             *model_map,
        uint64_t                model_size,
        uint64_t                weight_offset,
...
int ds4_gpu_matmul_q2_k_q8_k_tensor(
        ds4_gpu_tensor       *out,
        const void             *model_map,
        uint64_t                model_size,
        uint64_t                weight_offset,
...
int ds4_gpu_matmul_q4_k_q8_1_tensor(
        ds4_gpu_tensor       *out,
        const void             *model_map,
        uint64_t                model_size,
        uint64_t                weight_offset,
...
int ds4_gpu_matmul_f32_qwen_pair_tensor(
...
int ds4_gpu_matmul_q5_k_tensor(
        ds4_gpu_tensor       *out,
        const void             *model_map,
        uint64_t                model_size,
        uint64_t                weight_offset,
...
int ds4_gpu_matmul_q3_k_q8_k_tensor(
        ds4_gpu_tensor       *out,
        const void             *model_map,
        uint64_t                model_size,
        uint64_t                weight_offset,
...
int ds4_gpu_matmul_q4_k_q8_k_tensor(
        ds4_gpu_tensor       *out,
        const void             *model_map,
        uint64_t                model_size,
        uint64_t                weight_offset,
...
int ds4_gpu_matmul_iq3_xxs_q8_1_tensor(
        ds4_gpu_tensor       *out,
        const void             *model_map,
        uint64_t                model_size,
        uint64_t                weight_offset,
...
int ds4_gpu_matmul_q4_1_pair_tensor(
        ds4_gpu_tensor       *out_a,
        ds4_gpu_tensor       *out_b,
        const void             *model_map,
        uint64_t                model_size,
...
int ds4_gpu_matmul_q4_1_full_qkv_tensor(
...
int ds4_gpu_quantize_q8_1_tensor(
        ds4_gpu_tensor       *out,
        const ds4_gpu_tensor *x,
        uint64_t                n);

int ds4_gpu_quantize_q8_k_tensor(
        ds4_gpu_tensor       *out,
        const ds4_gpu_tensor *x,
        uint64_t                n);

int ds4_gpu_matmul_q4_1_q8_1_tensor(
        ds4_gpu_tensor       *out,
        const void             *model_map,
        uint64_t                model_size,
        uint64_t                weight_offset,
...
int ds4_gpu_qwen35_gate_up_swiglu_q2_k_q8_k_tensor(
        ds4_gpu_tensor       *mid,
        const void             *model_map,
        uint64_t                model_size,
        uint64_t                gate_offset,
...
int ds4_gpu_matmul_iq4_nl_tensor(
        ds4_gpu_tensor       *out,
        const void             *model_map,
        uint64_t                model_size,
        uint64_t                weight_offset,
...
int ds4_gpu_qwen35_gdn_step_fused_beta_alpha_tensor(
        ds4_gpu_tensor       *gated,
        ds4_gpu_tensor       *state,
        uint64_t                state_offset,
        ds4_gpu_tensor       *conv_cache,
        ...
        ds4_gpu_tensor       *beta,
        ds4_gpu_tensor       *alpha,
        const ds4_gpu_tensor *norm,
        const void             *model_map,
        uint64_t                model_size,
        uint64_t                conv_weight_offset,
        uint64_t                beta_weight_offset,
        uint64_t                alpha_weight_offset,
        uint64_t                dt_offset,
        uint64_t                a_offset,
        uint64_t                norm_weight_offset,
        uint32_t                n_embd,
...
int ds4_gpu_qwen35_full_attn_step_tensor(
